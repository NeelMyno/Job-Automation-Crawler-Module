...
- `pipeline/job-crawler/liveness.py` + `test_liveness.py`: an optional ghost-job re-checker.
  Re-verify the posting is actually still live before you spend time on a lead.
